...
export async function renderAccount() {
  ...
  if (themePicker) {
    const themeLabels: Record<string, string> = {
      ...
      "light": "Bauhaus Studio",
      "solarized-dark": "Blueprint",
      "solarized-light": "Washi",
      "nord": "Frosted Glass",
      "dracula": "Gothic Cathedral",
      "monokai": "Hacker Terminal",
      "cyberpunk": "Neon Dystopia",
      "ocean": "Deep Sea",
      "forest": "Enchanted Wood",
      "sunset": "Desert Mirage",
      "midnight-purple": "Cosmic Nebula",
      "cherry-blossom": "Sakura Garden",
      "retro-terminal": "Mainframe CRT",
      "high-contrast": "Brutalist A11y",
      "warm-earth": "Artisan Pottery",
      "arctic": "Scandinavian",
      "neon": "8-Bit Arcade",
      "paper": "Broadsheet",
