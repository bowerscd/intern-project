...
class TestMealbotOnlyCannotAccessHappyHour:
    ...
    def test_mealbot_user_cannot_list_events(
        self, mealbot_only_client: TestClient
    ) -> None:
    ...
    def test_mealbot_user_cannot_list_locations(
        self, mealbot_only_client: TestClient
    ) -> None:
...
class TestHappyHourOnlyCannotAccessMealbot:
    ...
    def test_hh_user_cannot_list_ledger(
    ...
    def test_hh_user_cannot_post_record(
        self, happyhour_only_client: TestClient
    ) -> None:
