...
class TestAuthenticatedMealbotFlow:
    ...
    def test_create_users_and_track_meals(self, authenticated_client: TestClient, database: 'Database') -> None:
        ...
        c.post("/api/v2/mealbot/record", json={
            "payer": "test", "recipient": "alice", "credits": 2
        })
        c.post("/api/v2/mealbot/record", json={
            "payer": "bobbi", "recipient": "test", "credits": 1
        })
